import { Marker, Guide } from "shared";
...
export const MOCK_GUIDES: Guide[] = [
  {
    ...
    checklistItems: [
      { id: "guide-1-c1", guideId: "guide-1", order: 1, textCs: "Nabijte telefony a powerbanky", textEn: "Charge your phone and power banks" },
      { id: "guide-1-c2", guideId: "guide-1", order: 2, textCs: "Připravte pitnou vodu (3l/osoba/den)", textEn: "Prepare drinking water (3l/person/day)" },
      { id: "guide-1-c3", guideId: "guide-1", order: 3, textCs: "Připravte svítilny a baterie", textEn: "Prepare flashlights and batteries" },
      { id: "guide-1-c4", guideId: "guide-1", order: 4, textCs: "Uložte si důležité kontakty offline", textEn: "Save important contacts offline" },
      { id: "guide-1-c5", guideId: "guide-1", order: 5, textCs: "Zkontrolujte starší sousedy", textEn: "Check on elderly neighbors" }
    ]
  },
  {
    id: "guide-2",
    ...
    checklistItems: [
      { id: "guide-2-c1", guideId: "guide-2", order: 1, textCs: "Zachovejte klid", textEn: "Stay calm" },
      { id: "guide-2-c2", guideId: "guide-2", order: 2, textCs: "Vypněte / odpojte citlivou elektroniku", textEn: "Turn off/unplug sensitive electronics" },
      { id: "guide-2-c3", guideId: "guide-2", order: 3, textCs: "Používejte raději baterky než svíčky", textEn: "Use flashlights instead of candles if possible" },
      { id: "guide-2-c4", guideId: "guide-2", order: 4, textCs: "Sledujte oficiální zprávy na mobilu či rádiu", textEn: "Check official city communications if internet is available" },
      { id: "guide-2-c5", guideId: "guide-2", order: 5, textCs: "Omezte zbytečné cestování", textEn: "Avoid unnecessary travel" }
    ]
  },
  {
    id: "guide-3",
    ...
    checklistItems: [
      { id: "guide-3-c1", guideId: "guide-3", order: 1, textCs: "Udržujte zásoby vody doma", textEn: "Keep drinking water at home" },
      { id: "guide-3-c2", guideId: "guide-3", order: 2, textCs: "Připravte si trvanlivé potraviny", textEn: "Prepare non-perishable food" },
      { id: "guide-3-c3", guideId: "guide-3", order: 3, textCs: "Neotvírejte zbytečně lednici a mrazák", textEn: "Avoid opening fridge/freezer often" },
      { id: "guide-3-c4", guideId: "guide-3", order: 4, textCs: "Najděte nejbližší nouzový zdroj pitné vody", textEn: "Check nearby supermarkets or support points" }
    ]
  },
  {
    id: "guide-4",
    ...
    checklistItems: [
      { id: "guide-4-c1", guideId: "guide-4", order: 1, textCs: "Udržujte léky snadno dostupné", textEn: "Keep essential medication available" },
      { id: "guide-4-c2", guideId: "guide-4", order: 2, textCs: "Zjistěte polohu nejbližší funkční nemocnice", textEn: "Know the nearest hospital or pharmacy" },
      { id: "guide-4-c3", guideId: "guide-4", order: 3, textCs: "Uložte si čísla na záchranné složky offline", textEn: "Save emergency numbers offline" },
      { id: "guide-4-c4", guideId: "guide-4", order: 4, textCs: "Zkontrolujte lidi závislé na el. přístrojích", textEn: "Check on people who need medical devices" }
    ]
  },
  {
    id: "guide-5",
    ...
    checklistItems: [
      { id: "guide-5-c1", guideId: "guide-5", order: 1, textCs: "Aktivujte úsporný režim v telefonu", textEn: "Keep phone battery low-power mode enabled" },
      { id: "guide-5-c2", guideId: "guide-5", order: 2, textCs: "Při slabém signálu preferujte SMS zprávy", textEn: "Use SMS when mobile data is unstable" },
      { id: "guide-5-c3", guideId: "guide-5", order: 3, textCs: "Dohodněte si s rodinou krizové místo setkání", textEn: "Agree on a meeting point with family" },
      { id: "guide-5-c4", guideId: "guide-5", order: 4, textCs: "Uložte si důležité kontakty fyzicky na papír", textEn: "Save addresses and contacts offline" }
    ]
  },
  {
    id: "guide-6",
    ...
    checklistItems: [
      { id: "guide-6-c1", guideId: "guide-6", order: 1, textCs: "Nikdy nepoužívejte venkovní vařiče uvnitř", textEn: "Do not use outdoor grills indoors" },
      { id: "guide-6-c2", guideId: "guide-6", order: 2, textCs: "Větrejte při použití alternativního topení", textEn: "Ventilate if using alternative heating" },
      { id: "guide-6-c3", guideId: "guide-6", order: 3, textCs: "Oblečte se do více vrstev teplého oblečení", textEn: "Wear layered clothing" },
      { id: "guide-6-c4", guideId: "guide-6", order: 4, textCs: "Dbejte na nebezpečí udušení/požáru", textEn: "Watch for carbon monoxide risks" }
    ]
  },
  {
    id: "guide-7",
    ...
    checklistItems: [
      { id: "guide-7-c1", guideId: "guide-7", order: 1, textCs: "Spotřebiče zapínejte postupně", textEn: "Turn appliances back on gradually" },
      { id: "guide-7-c2", guideId: "guide-7", order: 2, textCs: "Zkontrolujte stav potravin v lednici", textEn: "Check food safety" },
      { id: "guide-7-c3", guideId: "guide-7", order: 3, textCs: "Znovu dobijte powerbanky a telefony", textEn: "Recharge devices" },
      { id: "guide-7-c4", guideId: "guide-7", order: 4, textCs: "Aktualizujte stavy míst, která jste navštívili", textEn: "Update marker statuses if you visited a place" }
    ]
  }
];

export const MOCK_MESH_STATUS = {
  status: "DEGRADED",
  onlineNodes: 14,
  totalNodes: 18,
  lastIncidentAt: new Date(Date.now() - 1000 * 60 * 35).toISOString()
};

export function getMockAiResponse(message: string, lang: 'cs' | 'en'): string {
  const query = message.toLowerCase();
  
  if (lang === 'cs') {
    if (query.includes('vod') || query.includes('pít')) {
      return "### Nouzové zásobování vodou\n\n- **Výdejní místa:** Pitná voda je distribuována na **Náměstí Míru** (Nouzový bod) a ve **Všeobecné fakultní nemocnici**.\n- **Příprava:** Kohoutkovou vodu před pitím přefiltrujte přes čistou látku a převařte po dobu 1-3 minut.\n- **Upozornění:** Omezte splachování a mytí na minimum.";
    }
    if (query.includes('jídl') || query.includes('jíst') || query.includes('potravin')) {
      return "### Potraviny a zásobování\n\n- **Teplá strava:** K dispozici zdarma na nouzovém bodě **Náměstí Míru**.\n- **Nákup:** Supermarket **Albert na I.P. Pavlova** je otevřen v omezeném režimu. Platba je možná pouze **v hotovosti** (CZK/EUR).\n- **Bezpečnost:** K vaření na kempingovém vařiči využívejte výhradně venkovní prostory.";
    }
    if (query.includes('nemocnic') || query.includes('doktor') || query.includes('lékař') || query.includes('lék')) {
      return "### Lékařská péče a léky\n\n- **Akutní případy:** Hlavní lékařská péče funguje nepřetržitě ve **Všeobecné fakultní nemocnici v Praze** (U Nemocnice 499/2).\n- **Léky:** Základní léčiva a zdravotnický materiál vydává **Lékárna u sv. Ludmily** (Belgická 36).\n- **Tísňové volání:** V případě nouze volejte linku **112** nebo **155**.";
    }
    if (query.includes('proud') || query.includes('elektř') || query.includes('nabí') || query.includes('světl') || query.includes('nabít')) {
      return "### Elektřina a nabíjení\n\n- **Veřejné nabíjení:** Zdroje pro dobití telefonů a svítilen najdete v **Komunitním centru Sokol Vinohrady** (Polská 2400).\n- **Palivo:** Čerpací stanice **MOL Argentinská** má funkční generátor, odběr paliva je omezen na max. 20 litrů na osobu.\n- **Rada:** Zapněte na svém zařízení režim maximální úspory baterie.";
    }
    if (query.includes('signál') || query.includes('telefon') || query.includes('internet') || query.includes('wifi') || query.includes('síť')) {
      return "### Komunikace a sítě\n\n- **Nouzová Wi-Fi:** Místní mesh-síť bez přístupu k internetu běží u **Úřadu MČ Praha 2** (nám. Míru 20). Umožňuje posílat zprávy v rámci Prahy.\n- **SMS:** V přetížených sítích odesílejte SMS zprávy, mají vyšší šanci na doručení než volání.\n- **Zprávy:** Ladte Český rozhlas Radiožurnál na bateriovém nebo autorádiu.";
    }
    return "### Krizový poradce Praha (Offline)\n\nJsem váš nouzový asistent pro situaci výpadku proudu v Praze.\n\n- **Mapa:** Přejděte na záložku **Mapa** pro nalezení nejbližších nemocnic, cisteren s vodou a center pomoci.\n- **Návody:** Na záložce **Návody** najdete kontrolní seznamy pro zabezpečení domácnosti.\n- **Zeptejte se mě:** Zadejte klíčová slova jako *voda, jídlo, nemocnice, nabíjení nebo signál* pro specifické rady.";
  } else {
    if (query.includes('water') || query.includes('drink')) {
      return "### Emergency Water Supply\n\n- **Distribution Points:** Free drinking water is distributed at **Namesti Miru Support Point** and **General University Hospital**.\n- **Preparation:** Filter tap water through a clean cloth and boil for 1-3 minutes before drinking.\n- **Conservation:** Limit flushing and non-essential washing to conserve supplies.";
    }
    if (query.includes('food') || query.includes('eat') || query.includes('grocery') || query.includes('supermarket')) {
      return "### Food and Provisions\n\n- **Hot Food:** Distributed free of charge at the **Namesti Miru Emergency Support Point**.\n- **Groceries:** **Albert Supermarket at I.P. Pavlova** is open with limited hours. Note: **Cash only** (CZK/EUR).\n- **Stoves:** Only use camping stoves outdoors due to carbon monoxide hazards.";
    }
    if (query.includes('hospital') || query.includes('doctor') || query.includes('medical') || query.includes('medicin') || query.includes('pharmacy')) {
      return "### Medical Care and Pharmacy\n\n- **Emergency Medical Care:** General emergency department is active at **General University Hospital in Prague** (U Nemocnice 499/2).\n- **Medicine:** Basic medicines can be acquired at **St. Ludmila Pharmacy** (Belgická 36).\n- **Emergency Lines:** If life is threatened, dial **112** or **155**.";
    }
    if (query.includes('power') || query.includes('electr') || query.includes('charg') || query.includes('light')) {
      return "### Power and Device Charging\n\n- **Power Station:** Small electronic devices (phones, flashlights) can be recharged at **Sokol Vinohrady Community Center** (Polská 2400).\n- **Fuel:** **MOL Prague Argentinska** gas station has a backup generator. Fuel purchase is limited to max 20L per customer.\n- **Tip:** Put your smartphone into Extreme Battery Saver mode.";
    }
    if (query.includes('signal') || query.includes('phone') || query.includes('internet') || query.includes('wifi') || query.includes('network')) {
      return "### Communication and Networks\n\n- **Emergency Wi-Fi:** Local mesh network (no internet egress) is active near **Prague 2 District Office** (nám. Míru 20). Allows local peer messages.\n- **SMS:** Prefer SMS over voice calls as SMS requires much lower signal and bandwidth.\n- **Radio:** Tune a portable or car radio to official emergency broadcast frequencies.";
    }
    return "### Crisis Advisor Prague (Offline)\n\nI am your offline emergency guide during the current Prague power blackout.\n\n- **Map:** View the **Map** tab to locate nearby hospitals, water supply tanks, and shelters.\n- **Guides:** Check the **Guides** tab for checklist instructions on preparing your household.\n- **Ask me:** Enter keywords like *water, food, medical, charging, or signal* for specific advice.";
  }
}
